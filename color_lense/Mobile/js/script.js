...
$(function() {
	...
	/* 상품리스트 2열 버그 */
	var oddList = [$(".type_big_single.x2 .list li:nth-child(2n-1)"),$(".type_big_single.x4 .list li a:nth-child(2n-1)")];
	function listResize() {
		if (oddList.length){
			for(var n=0; n<oddList.length; n++){
				oddList[n].each(function(i,e){
	...
	listResize();
	window.addEventListener("resize", listResize);
});